...
class RandomRenderer(object):
    ...
    #
    ##
    def __init__(self, Environment: Type[Environment], Camera: Type[Camera], Display: Type[Display], Robot: Type[Robot]):
    ...
    def render(self):
        ...
        panelCenter = (self.display.displayWidth - (self.display.displayWidth / 5)) + (
                    (self.display.displayWidth / 5) / 2)

        self.display.pygame.draw.circle(self.display.displaySurface, getColor('black'), (int(panelCenter), 50), 20, 3)
        self.display.pygame.draw.line(self.display.displaySurface, getColor('black'), (int(panelCenter), 70),
                                      (int(panelCenter), 80), 3)
        ...
        self.display.pygame.draw.polygon(self.display.displaySurface, getColor('black'),
                                         [WarrowEndPoint1, WarrowEndPoint2, WarrowEndPoint3], 2)
        self.display.pygame.draw.polygon(self.display.displaySurface, getColor('black'),
                                         [EarrowEndPoint1, EarrowEndPoint2, EarrowEndPoint3], 2)
        self.display.pygame.draw.polygon(self.display.displaySurface, getColor('red'),
                                         [NarrowEndPoint1, NarrowEndPoint2, NarrowEndPoint3], 2)
        self.display.pygame.draw.polygon(self.display.displaySurface, getColor('black'),
                                         [SarrowEndPoint1, SarrowEndPoint2, SarrowEndPoint3], 2)
        self.display.pygame.draw.polygon(self.display.displaySurface, getColor('black'),
                                         [NEarrowEndPoint1, NEarrowEndPoint2, NEarrowEndPoint3], 2)
        self.display.pygame.draw.polygon(self.display.displaySurface, getColor('black'),
                                         [SEarrowEndPoint1, SEarrowEndPoint2, SEarrowEndPoint3], 2)
        self.display.pygame.draw.polygon(self.display.displaySurface, getColor('black'),
                                         [SWarrowEndPoint1, SWarrowEndPoint2, SWarrowEndPoint3], 2)
        self.display.pygame.draw.polygon(self.display.displaySurface, getColor('black'),
                                         [NWarrowEndPoint1, NWarrowEndPoint2, NWarrowEndPoint3], 2)
    ...
    def flashHall(self):
        ...
        self.display.pygame.draw.line(self.display.displaySurface, getColor('red'), (int(panelCenter) + 20, 70),
                                      (getEndPoint(50, 15, (int(panelCenter) + 20, 70))), 3)
        self.display.pygame.draw.line(self.display.displaySurface, getColor('red'), (int(panelCenter) - 20, 70),
                                      (getEndPoint(130, 15, (int(panelCenter) - 20, 70))), 3)
        self.display.pygame.draw.line(self.display.displaySurface, getColor('red'), (int(panelCenter) - 20, 30),
                                      (getEndPoint(230, 15, (int(panelCenter) - 20, 30))), 3)
        self.display.pygame.draw.line(self.display.displaySurface, getColor('red'), (int(panelCenter) + 20, 30),
                                      (getEndPoint(320, 15, (int(panelCenter) + 20, 30))), 3)
