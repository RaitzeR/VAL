...
class EnvironmentRenderer(object):
    ###
     ...
     #
     ##
    def __init__(self, Environment, Camera, Display):
    ...
    def render(self,backgroundColor,wallColor,scanLineColor):
    ...
    def renderScanLines(self,roboPoint, intersectPoint,color):
        self.display.pygame.draw.line(self.display.displaySurface,
                                 color,
